#!/usr/bin/env python3
"""
根據定價 CSV 更新 nch.html（觀眾瀏覽版）
用法: python3 apply-pricing.py <csv檔案>
範例: python3 apply-pricing.py NCH定價-2026-04-03.csv

CSV 格式（由 editor-nch.html 匯出）：
...
def main(csv_path):
    ...
    # ── 讀 nch.html（已含 data 屬性的 SVG）────────────────────────────
    out_path = Path('../../nch/nch.html')
