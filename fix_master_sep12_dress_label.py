...
SOURCE = Path('/private/tmp/sep12_dress_update/Da_Zong_Guan_Master_Schedule.docx')
OUTPUT = Path('/private/tmp/sep12_dress_update/Da_Zong_Guan_Master_Schedule.docx')
